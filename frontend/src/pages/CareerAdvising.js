      ...
      <div className="px-6">
        <section className="flex-1 py-6 text-center">
          <div className="bg-white p-6 shadow rounded">
            ...
            <p className="text-gray-700">
              As you manage your lifelong professional journey, the RGUKT Alumni
              Association can connect you to career advising and networking
              opportunities within the RGUKT community and recommend help from
              RGUKT experts in your professional areas of interest.
            </p>
            <br />
            <a
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded shadow">
            ...
            <p>
              Undergraduate students, learn more about the Hub and how to get
              started.
            </p>
          </div>
          {/* Column 2 */}
          <div className="bg-white p-6 rounded shadow">
            ...
            <p>Graduate students, learn more about the Hub and get started.</p>
          </div>
          {/* Column 3 */}
          <div className="bg-white p-6 rounded shadow">
            <img
            ...
            <p>
              Alumni who want to volunteer their time and sign up to be an
              advisor and give advice to students and fellow alumni, learn more
              here.
            </p>
          </div>
          {/* Column 4 */}
          <div className="bg-white p-6 rounded shadow">
            ...
            <p>
              Connecting to RGUKT alumni for professional advice and navigating
              your career has never been easier. Get started here, login with
              your credentials to create a profile, or access the platform.
            </p>
          </div>
          {/* Column 5 */}
          <div className="bg-white p-6 rounded shadow">
        ...
        <div>
          <div>
            <h1
              href="https://hub.rgukt.ac.in/hub/"
              className="text-2xl text-red-500 m-4 text-center"
            >
