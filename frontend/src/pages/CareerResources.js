    ...
    <Careers>
      <div className="bg-gray-100 px-6 py-10">
        <section className="flex-1 py-6 text-center">
          <div className="bg-white p-6 shadow rounded">
            ...
            <p className="text-gray-700">
              Job searches and career changes can be equally daunting. From researching career paths to honing your interviewing skills, these career tools and resources offer you tips, assessments, books, and other learning aids to help you along the journey.</p>
          </div>
        </section>
        ...
        <div>
          ...
          {openSection === "jobBoards" && (
            <div className="pl-4 py-2 text-gray-600">
              <p>Explore various job boards and search engines to aid your career development.</p>
            </div>
          )}
        </div>
          ...
          {openSection === "books" && (
            <div className="pl-4 py-2 text-gray-600">
              <ul className="list-disc pl-5">
                <li>
                  <strong>The Pathfinder:</strong> How To Choose or Change Your Career For a Lifetime
                  of Satisfaction by Nicholas Lore
                </li>
                <li>
                  <strong>Do What You Are:</strong> Discover the Perfect Career for You Through the
                  Secrets of Personality Type by Paul Tieger, Barbara Barron, and Kelly Tieger
                </li>
                <li>
                  <strong>What Color Is Your Parachute?:</strong> A Practical Manual for Job-Hunters
                ...
                <li>
                  <strong>Put Your Science To Work:</strong> The Take-Charge Career Guide for
                  Scientists by Peter S. Fiske
                </li>
                <li>
                  <strong>Bounce:</strong> Mozart, Federer, Picasso, Beckham, and the Science of
                  Success by Matthew Syed
                </li>
                <li>
                  <strong>Love It Don't Leave It:</strong> 26 Ways to Get What You Want At Work by
                  Beverly Kaye
                </li>
              </ul>
            </div>
        ...
        <div>
          ...
          {openSection === "tools" && (
            <div className="pl-4 py-2 text-gray-600">
              <p>Discover occupational tools and resources for career planning.</p>
            </div>
          )}
        </div>
          ...
          {openSection === "careerPaths" && (
            <div className="pl-4 py-2 text-gray-600">
              <p>
                ...
                Alumni like you are always welcome to attend most RGUKT CAPD on-campus workshops, company information sessions, presentations, webinars, and career fairs. Advance registration is often required.
        ...
        <div>
          ...
          {openSection === "careerPaths" && (
            <div className="pl-4 py-2 text-gray-600">
              <p>
                The RGUKT Alumni Advisors Hub is an online platform that facilitates one to one career conversations with alumni volunteers who are willing to chat and share career and professional advice with students of their fellow alumni.
